...
final class ChunkShader extends finalforeach.cosmicreach.rendering.shaders.ChunkShader {
    public ChunkShader(final Identifier vertFile, final Identifier fragFile) {
